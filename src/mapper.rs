...
fn extend_paired_seeds(
        ...
        && is_proper_nam_pair(&nams[0][0], &nams[1][0], mu, sigma)
    {
        ...
        let consistent_nam1 = n_max1.is_consistent(read1, references, k, adna_mode, ry_len);
        details[0].inconsistent_nams += !consistent_nam1 as usize;
        let consistent_nam2 = n_max2.is_consistent(read2, references, k, adna_mode, ry_len);
